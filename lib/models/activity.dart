...
/// and addiconst ng [Activtiy] object is like addiconst ng new row in database.
@freezed
...
List<Activity> mActivityList = []
  ...
  ..add(const Activity(
    ...
    note: '''
        Dear Diary, 
        Following the daily routine, I started my day with some exercise and a hearty breakfast. After that, I dedicated some quality time to my open-ended project and planned newer features to be addeconst d, as an improvement. I helped my mentees. It was an amazing day, and I spent it productively learning new things and techniques to be better. Bye-bye diary :)
        ''',
  ))
  // Angry Day
  ..add(const Activity(
    ...
    note: """
        ...
        ...Or is the pause our unproductive way of addrconst essing our fear of change?
