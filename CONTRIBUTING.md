...
Please check out the [issues](https://github.com/hashirshoaeb/star_book/issues) and [project board](https://github.com/users/hashirshoaeb/projects/1) for any current concerns or topics related to the project. Additionally, we now use Discord for project management and communication. Feel free to join our Discord server [here](https://discord.gg/7EJv8VUGrd) for the latest updates and discussions.
