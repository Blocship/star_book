...
│       ├── /main/profile/analytics (AyalyticsScreen)
│       └── /main/profile/settings (SettingsScreen)
│           └── /main/profile/license (LicenseAgreementScreen) 
├── /journals?date=2020-01-01 (JournalsListScreen)
│   ├── /journal/new?date=2020-01-01 (NewJournalScreen)
